...
{
    InvalidArgument, WrongContext, StaleEntity, CrossWorld, UnknownComponent, UnknownField,
    DuplicateRegistration, CapacityExceeded, BudgetExceeded, QueryBoundary, ViewExpired,
    WorldNotReady, WorldDraining, WorldDisposed, WorldFaulted, OwnerThreadViolation,
    StructuralChangeInView, CycleDetected, DependencyMissing, MutualExclusion, PostWriteFailure,
    SnapshotUnavailable, SnapshotReleased, SnapshotDoubleRelease, InvalidType, InvalidState
}
...
internal static class EcsBoundaryErrors
{
    ...
    {
        EcsDiagnosticReason.WrongContext or EcsDiagnosticReason.CrossWorld or EcsDiagnosticReason.QueryBoundary or EcsDiagnosticReason.WorldNotReady or EcsDiagnosticReason.OwnerThreadViolation or EcsDiagnosticReason.StructuralChangeInView => "WrongContext",
        ...
        EcsDiagnosticReason.StaleEntity or EcsDiagnosticReason.ViewExpired or EcsDiagnosticReason.SnapshotReleased => "InvalidHandle",
        ...
        EcsDiagnosticReason.WorldFaulted or EcsDiagnosticReason.PostWriteFailure or EcsDiagnosticReason.InvalidState => "InternalInvariant",
        _ => "InvalidArgument"
    };
...
internal enum EcsFailureClass { Rejected, Retryable, Fatal, FatalInvariant }
internal sealed class EcsFailure : Exception
{
    internal EcsFailure(EcsFailureClass failureClass, string code, string message, Exception? inner = null) : base(message, inner) { Class = failureClass; Code = code; }
    internal EcsFailureClass Class { get; }
    internal string Code { get; }
    internal bool IsFatal => Class is EcsFailureClass.Fatal or EcsFailureClass.FatalInvariant;
}
